...
export default function CategoryPage({ videoByCate, slug, categoryInfo }) {
  ...
  const handleLoadMoreData = () => {
    ...
    getVideoPagingByClass("video", pageSize, pageIndex + 1).then((dataMore) => {
      ...
      >
        ...
        >
          ...
          <div style={{ display: "grid" }}>
            <span style={{ color: "white" }}>All Movies</span>
            <span
        ...
        <div
          ...
          style={{
            ...
            padding: isMobile ? "10px 10px" : "20px 10%",
          }}
        >
          <Row gutter={[12, 24]}>
...
export async function getServerSideProps({ params }) {
  const [videoByCate] = await Promise.all([
    getVideoPagingByClass("video", 6, 1),
